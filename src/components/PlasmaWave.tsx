...
export default function PlasmaWave({
  xOffset = 0,
  yOffset = -200, // Raise up by 200px to go through navbar
  rotationDeg = 135, // Rotate 90 degrees from 45 to 135
  focalLength = 0.8,
  speed1 = 0.1, // Original settings from instruction doc
  speed2 = 0.1,
  dir2 = 1.0,
  bend1 = 0.9, // Original settings from instruction doc
  bend2 = 0.6,
  fadeInDuration = 2000
}) {
